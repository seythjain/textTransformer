...
Examples:
  * nn.MultiheadAttention — would replace the manual Q/K/V projections, attention scores, masking, and head splitting.
  ...
  * nn.TransformerEncoder — would stack Transformer blocks.
